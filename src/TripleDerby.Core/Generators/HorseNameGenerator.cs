...
namespace TripleDerby.Core.Generators
{
...
";
        ...
        public string Generate()
        {
            ...
            return r < 0.75
                ? $"{CapitalizeFirst(adverb)} {CapitalizeFirst(adjective)}"
                : $"{CapitalizeFirst(adverb)} {CapitalizeFirst(adjective)} {CapitalizeFirst(noun)}";
        }

        private static List<string> ProcessRawData(string thingyToSplit)
        {
            var candidates = Regex.Split(thingyToSplit, "\\s+");

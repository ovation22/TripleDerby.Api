...
{
    public class Get : TrainingsControllerTestBase
    {
        ...
        [Fact]
        public async Task ItGetsTraining()
        {
            // Arrange
            // Act
            ...
            // Assert
            TrainingService.Verify(x => x.Get(_id), Times.Once());
        }
        ...
        {
            // Arrange
            TrainingService.Setup(x => x.Get(_id)).Throws(new Exception());
        ...
        public async Task GivenException_ThenItLogsError()
        {
            ...
            TrainingService.Setup(x => x.Get(_id)).Throws(ex);
